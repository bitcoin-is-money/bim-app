...
import { TransactionHash, TransactionId, UserAddressId } from '../user/types';
/**
...
export interface TransactionRepository {
     ...
     */
    findByUserAddressId(userAddressId: UserAddressId, options: TransactionPaginationOptions): Promise<Transaction[]>;
    /**

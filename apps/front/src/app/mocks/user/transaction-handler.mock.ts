...
const MOCK_TRANSACTIONS: Transaction[] = [
  mockTx('1', 'receive', '5000000', 1, 'Salary'),
  mockTx('2', 'send', '2500000', 2, 'Rent'),
  mockTx('3', 'receive', '15000000', 3),
  mockTx('4', 'send', '750000', 5, 'Coffee shop'),
  mockTx('5', 'receive', '32000000', 6, 'Freelance gig'),
  mockTx('6', 'send', '1200000', 8),
  mockTx('7', 'receive', '8500000', 10, 'Refund'),
  mockTx('8', 'send', '450000', 12),
  mockTx('9', 'receive', '20000000', 14, 'Invoice #1042'),
  mockTx('10', 'send', '3000000', 15, 'VPN subscription'),
  mockTx('11', 'receive', '6700000', 18),
  mockTx('12', 'send', '9900000', 20, 'Hardware wallet'),
  mockTx('13', 'receive', '1100000', 22),
  mockTx('14', 'send', '500000', 24),
  mockTx('15', 'receive', '42000000', 25, 'Bonus'),
  mockTx('16', 'send', '2800000', 27),
  mockTx('17', 'receive', '600000', 28),
  mockTx('18', 'send', '1500000', 30, 'Gift'),
  mockTx('19', 'receive', '7300000', 32),
  mockTx('20', 'send', '4100000', 34),
  mockTx('21', 'receive', '900000', 36),
  mockTx('22', 'send', '11000000', 38, 'Domain name'),

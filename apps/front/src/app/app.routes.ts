...
export const routes: Routes = [
  ...
  },
  {
    path: 'account-setup',
    loadComponent: () =>
      import('./pages/account-setup/account-setup.page').then((m) => m.AccountSetupPage),
  ...
  },
  {
    path: 'pay/confirm',
    loadComponent: () =>
      import('./pages/pay-confirm/pay-confirm.page').then((m) => m.PayConfirmPage),
    canActivate: [authGuard],
  },
  {
    path: 'pay/success',
    loadComponent: () =>
      import('./pages/pay-success/pay-success.page').then((m) => m.PaySuccessPage),
    canActivate: [authGuard],
  },
  {
    path: 'updating',
